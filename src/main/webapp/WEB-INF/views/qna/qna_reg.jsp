				...
				<form>
					<table>
						...
						<tr>
							<th>내용</th>
							<td class="row">
								<textarea class="col-11" name="qna_contents" id="qna_contents" style="height: 400px; resize: none; margin-left: 20px;"></textarea>
							</td>
						</tr>
							...
							<td>
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="qna_public_lev" id="public1" value="1" checked>
										<label class="form-check-label" for="1">공개</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="qna_public_lev" id="public2" value="0"> 
										<label class="form-check-label" for="0">비공개</label>
									</div>
