...
<!-- ======= Top Bar ======= -->
  ...
  <div>
    ...
    <button type="button" class="btn btn-dark" onclick="location.href=''" style="cursor:pointer;">
			좋아요	<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-heart" viewBox="0 0 16 16">
