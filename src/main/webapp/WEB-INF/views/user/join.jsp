		...
		<div class="wrap" align="center">
			<form method="post">
				...
				<div class="gender_wrap">
					...
					<label for="남">남</label> <input type="radio" id="gender_female"
						name="contact" value="여"> <label for="여">여</label>
				</div>
				...
				<div class="addr_wrap">
					...
					<div class="zip_code_wrap">
						<input id="user_zip_code" name="user_zip_code"> <input
							type="button" value="주소찾기" onclick="kakao_addr()">
					</div>
				...
				<div class="join_button_wrap">
					<input type="button" class="join_btn" value="가입하기"
						...
						class="cancel_btn" value="취소" onclick="history.go(-1)">
				</div>
			</form>
		</div>
		<!-- wrap -->
