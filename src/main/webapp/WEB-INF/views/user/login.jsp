...
<header>
<a href="#" onclick="location.href='culture.do'" class=" cotainer logo d-flex justify-content-center" style="margin-top: 150px;">
<img src="resources/img/the_culture_logo.png" alt="" width="165px"></a>
</header>
<main>
	<div class="content row  d-flex justify-content-center ">
		...
		<div class="col-5 container d-flex justify-content-center row">
			...
			<div class="col-7" style="border: 2px solid #e2e2e2; padding: 20px 20px; margin-top: 25px; border-radius: 20px;">
						...
						<form>
						<input class="form-control col" name="user_id" type="text" placeholder="아이디" style="margin-top: 20px;">
						<input class="form-control col" name="user_pw" type="password" placeholder="비밀번호" style="margin-top: 20px;">
						
						<button type="button" class="btn btn-primary col-12" style="margin-top: 20px;" onclick="login(this.form);">로그인</button>
						<button type="button" id="btn1" class="btn col-12" >네이버 로그인</button>
						<button type="button" id="btn2" class="btn col-12" >카카오 로그인</button>
						</form>
						<hr>
						<div id="atag"class="d-flex justify-content-center" style="font-size: 13px;">
